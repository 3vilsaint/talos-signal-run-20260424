...
This repo includes `.devcontainer/devcontainer.json` using a Node 20 devcontainer image with tmux, SSH handoff support, and system/user Git safe-directory setup for mounted workspaces.
